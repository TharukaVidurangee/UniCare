            ...
            <div class="container" align="Center" style="padding-top: 100px">
                <table>
                    <tr style="background-color:black">
                        ...
                        <th style="padding: 20px">Advisor</th>
                    ...
                    <tr style="background-color:blue">
                        ...
                        <th style="padding: 20px">{{$news->doctor}}</th>
                        ...
                        <th style="padding: 20px">
                        <a class="btn btn-success" href="{{url('approve_user_appointment',$news->id)}}">Approve</a>
                        </th>
                        <th style="padding: 20px">
                        <a class="btn btn-danger" href="{{url('reject_user_appointment',$news->id)}}">Reject</a>
                        </th>
                    </tr>
                    @endforeach
                </table>
